...
-- 윈도우 > 설정 > 연결 > 연결유형 Auto commit by defailt 체크 해제 확인!!

-- 주의 : 혼자 COMMIT , ROLLBACK 하지 말 것!
...
--1) INSERT INTO 테이블명 VALIES(데이터,데이터,데이터......);
-- 테이블에 있는 모든 컬럼에 대한 값을 INSERT 할 때 사용

INSERT INTO EMPLOYEE2 
VALUES('900','홍길동','991215-1234567','hong_g@gmail.com',
...
-- (DEFAULT 존재 시 DEFUALT 설정값으로 삽입됨)

INSERT INTO EMPLOYEE2(EMP_ID,EMP_NAME,EMP_NO)
VALUES ('900','양충모','040429-310715');
...
INSERT INTO  EMP_M02
VALUES(999,'곽두원','550505-1234567','Kwack_d@DR','0103030303','D9','J4','S1',
9000000,0.5,NULL,SYSDATE,NULL,NULL);
